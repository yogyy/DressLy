...
<template>
  <li
    class="card flex w-fit flex-col gap-4 rounded-lg border p-4 shadow-sm transition-colors duration-300 hover:cursor-pointer hover:bg-[#E9E9E9]"
  >
    <img :src="img" :alt="alt" class="rounded-md" />
    <div class="flex flex-col gap-2">
      <h1
        class="text-base font-semibold leading-[140%] text-[#12070B] sm:text-xl"
      >
        {{ title }}
      </h1>
